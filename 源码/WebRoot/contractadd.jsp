...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
 	...
 	<form action="/Hrm/ContractServlet?actioncode=add" method="post">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4" style="border:1px solid #AEDEF4">
   
   
	<tr>
	<td width="15%" height="25" align="center" bgcolor="#EFFBFE">合同ID</td>
		  <td width="15%" height="25" align="center" bgcolor="#FFFFFF"><input type="text" name="cosid" " /></td>
	</tr>
	<tr>
    <td width="10%" align="center" bgcolor="#EFFBFE">员工ID</td>
		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text"name="empid"  /></td>
	</tr>
	<tr>
	<td width="13%" align="center" bgcolor="#EFFBFE">合同编号</td>
		  <td width="13%" align="center" bgcolor="#FFFFFF"><input type="text"name="cosnum"  /></td>
	</tr>
	<tr>
	<td width="10%" align="center" bgcolor="#EFFBFE">合同开始</td>
		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text"name="startdate" /></td>
	</tr>
	<tr>
	<td width="22%" align="center" bgcolor="#EFFBFE">合同结束</td>
		  <td width="22%" align="center" bgcolor="#FFFFFF"><input type="text"name="emddate"  /></td>
	</tr>
	<tr>
	<td width="15%" align="center" bgcolor="#EFFBFE">岗位</td>
		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="job"  /></td>
	</tr>
	<tr>
	<td width="15%" align="center" bgcolor="#EFFBFE">合同内容</td>
		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="content" /></td>
	 </tr> 
    <tr>   
    	<td colspan="9" width="100%" align="center" bgcolor="#EFFBFE"><input type="submit" value="增加"></td>
   </tr>
</table>
</form>
</body>
