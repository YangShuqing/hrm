...
<table width="99%" height="25" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-bottom:4px;">
      <tr>
        ...
        <td width="466" background="Images/bj4.gif">admin(管理员):你好！欢迎光临，您上次登录时间是：2015-09-20 23:15:15		
		</td>
          ...
          <tr>
            ...
            <td width="68%" background="Images/b2.jpg"><table width="124" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="104" align="left" class="biao">帮助中心</td>
                </tr>
            </table></td>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
  <tr>
    <td width="5%" height="25" align="center" bgcolor="#D6F2FD">ID</td>
    <td width="42%" align="center" bgcolor="#D6F2FD">标题</td>
    <td colspan="2" align="center" bgcolor="#D6F2FD">类别</td>
    <td width="16%" align="center" bgcolor="#D6F2FD">发布者</td>
  </tr>
    <tr>
    <td height="25" bgcolor="#FFFFFF">2</td>
    <td bgcolor="#FFFFFF"><a href="#" >项目需求文档</a></td>
    <td width="20%" align="center" bgcolor="#FFFFFF"></td>
    <td width="17%" align="center" bgcolor="#FFFFFF">文档</td>
    <td align="center" bgcolor="#FFFFFF"></td>
  </tr>
    <tr>
    <td height="25" bgcolor="#FFFFFF">1</td>
    <td bgcolor="#FFFFFF"><a href="#" >总体设计方案</a></td>
    <td width="20%" align="center" bgcolor="#FFFFFF"></td>
    <td width="17%" align="center" bgcolor="#FFFFFF">文档</td>
    <td align="center" bgcolor="#FFFFFF"></td>
  </tr>
    ...
    <td colspan=2" bgcolor="#FFFFFF"> <span class='pagelink'><</span> <span class='pagelink'><<</span> <a class='pagelink' href='http://zcysysb.sdu.edu.cn:4500/sdxmmanage/teacher/helplist.php?NowPage=1'><font color=green>[1]</font></a>  <span class='pagelink'>>></span> <span class='pagelink'>></span> 转到第&nbsp;<input id='JumpSelect' type='text' size='2' value='1'onBlur="javascript:if(isNaN(parseInt(this.value)) || parseInt(this.value) > 1){alert('您输入的数字只能在 1 ～ 1之间，请重新输入'); }location.href='http://zcysysb.sdu.edu.cn:4500/sdxmmanage/teacher/helplist.php?NowPage='+parseInt(this.value)" title='鼠标外部单击，文章转向'> 页	</td>
