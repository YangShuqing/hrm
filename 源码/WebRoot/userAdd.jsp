...
<script language="javascript">
	function sub(){
		if(confirm("确认添加？")){
			windon.location.href="/Hrm/userServlet?actionCode=addUserSubmit";
		}else{
			return false;
		}
	}
...
<form id="form1" name="form1" method="post" action="/Hrm/userServlet?actionCode=addUserSubmit">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
    <tr>
      <td width="21%" height="25" align="right" bgcolor="#D6F2FD">新用户ID&nbsp;</td>
      <td width="79%" bgcolor="#FFFFFF"><label>
        &nbsp;
        <input name="userid2" type="text" id="oldpw" />
      </label></td>
    </tr>
    <tr>
      <td width="21%" height="25" align="right" bgcolor="#D6F2FD">新用户名&nbsp;</td>
      <td width="79%" bgcolor="#FFFFFF"><label>
        &nbsp;
        <input name="username2" type="text" id="oldpw" />
      </label></td>
    </tr>
    <tr>
      ...
      <td bgcolor="#FFFFFF"><label>
        &nbsp;
        <input name="password2" type="password" id="pw" />
      </label></td>
    </tr>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#FFFFFF">
        <form action="/Hrm/userServlet?actionCode=addUserSubmit" method="post">
