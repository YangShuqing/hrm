...
<form id="form1" name="form1" method="post" action="/Hrm/deptServlet?actionCode=addDeptSubmit">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4">
    <tr>
      <td width="21%" height="25" align="right" bgcolor="#D6F2FD">新部门ID&nbsp;</td>
      <td width="79%" bgcolor="#FFFFFF"><label>
        &nbsp;
        <input name="deptid2" type="text" id="oldpw" />
      </label></td>
    </tr>
    <tr>
      <td width="21%" height="25" align="right" bgcolor="#D6F2FD">新部门名&nbsp;</td>
      <td width="79%" bgcolor="#FFFFFF"><label>
        &nbsp;
        <input name="deptname2" type="text" id="oldpw" />
      </label></td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#FFFFFF">
        <form action="/Hrm/deptServlet?actionCode=addDeptSubmit" method="post">
