  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
   ...
   <table width="174" border="0" align="left" cellpadding="0" cellspacing="0">
           <tr>
             ...
             <td width="154" align="left" class="biao">预测退休员工查询</td>
           </tr>
   </table>
   </table>
...
<table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" >
    <tr>      
   		<td width="40%" align="right" bgcolor="#E2F7FE">
			<form action="/Hrm/retiredEmpServlet?actioncode=page2" method="post">
   					<input type="submit" value="查询全部"/>
   			</form>
   		</td>
   		<td  width="60%" align="left" bgcolor="#E2F7FE">
			<form action="/Hrm/retiredEmpServlet?actioncode=page3" method="post" id="form1">
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table id="form1" width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4" style="border:1px solid #AEDEF4">
    <tr>
