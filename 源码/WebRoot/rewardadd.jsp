          ...
          <tr>
            ...
            <td width="68%" background="Images/b2.jpg"><table width="174" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="154" align="left" class="biao">惩奖管理</td>
                </tr>
            </table></td>
            <td width="31%" align="right" background="Images/b2.jpg"><img src="Picture/b3.jpg" width="9" height="26" /></td>
          </tr>
</table>
 	<form action="/Hrm/RewardServlet?actioncode=add" method="post">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4" style="border:1px solid #AEDEF4">
   
   
	<tr>
	    <td height="25" align="center" bgcolor="#EFFBFE">奖惩ID</td>
		    <td height="25" align="center" bgcolor="#FFFFFF"><input type="text" name="rewid"/></td>
	</tr>
	<tr>	
		<td align="center" bgcolor="#EFFBFE">员工ID</td> 
		    <td align="center" bgcolor="#FFFFFF"><input type="text" name="empid" /></td>
		</tr>
		<tr>
		<td align="center" bgcolor="#EFFBFE">获奖人员姓名</td>
		    <td align="center" bgcolor="#FFFFFF"><input type="text" name="empname" /></td>
		</tr>
		<tr>
		<td  align="center" bgcolor="#EFFBFE">惩奖时间</td> 
		    <td align="center" bgcolor="#FFFFFF"><input type="text" name="rewdate"/></td>
		</tr>
		<tr>
		<td align="center" bgcolor="#EFFBFE">惩奖内容</td>
		    <td align="center" bgcolor="#FFFFFF"><input type="text" name="rewtype"/></td>
		</tr>
		<tr>
		<td align="center" bgcolor="#EFFBFE">惩奖标题</td>  
		   <td align="center" bgcolor="#FFFFFF"><input type="text" name="rewtitle"/></td>
		</tr>
		<tr>
		<td align="center" bgcolor="#EFFBFE">奖金类别</td> 
		   <td align="center" bgcolor="#FFFFFF"><input type="text" name="rewcontent"/></td>
		  
     </tr> 
    <tr>   
    	<td colspan="9" width="100%" align="center" bgcolor="#EFFBFE"><input type="submit" value="增加"></a></td>
