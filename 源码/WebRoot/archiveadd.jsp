          ...
          <tr>
            ...
            <td width="68%" background="Images/b2.jpg"><table width="174" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="154" align="left" class="biao">增加员工档案</td>
                </tr>
            </table></td>
            <td width="31%" align="right" background="Images/b2.jpg"><img src="Picture/b3.jpg" width="9" height="26" /></td>
          </tr>
</table>
 	<form action="/Hrm/ArchiveServlet?actioncode=add" method="post">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4" style="border:1px solid #AEDEF4">
    <tr>
		  <td width="15%" height="25" align="center" bgcolor="#EFFBFE">档案ID</td>
		  		  <td width="15%" height="25" align="center" bgcolor="#FFFFFF"><input type="text" name="arcid"/></td>
		  </tr>
           <tr>   <td width="10%" align="center" bgcolor="#EFFBFE">人员ID</td>
              		  		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text"name="empid"  /></td>
               </tr>
		<tr>  <td width="13%" align="center" bgcolor="#EFFBFE">档案编号</td>
		  		  <td width="13%" align="center" bgcolor="#FFFFFF"><input type="text"name="arcnum"  /></td>
		   </tr>
		 <tr> <td width="10%" align="center" bgcolor="#EFFBFE">名称</td>
		  		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text" name="arcname"  /></td>
		   </tr>
		<tr>  <td width="22%" align="center" bgcolor="#EFFBFE">摘要</td>
		  		  <td width="22%" align="center" bgcolor="#FFFFFF"><input type="text"name="summary" /></td>
		   </tr>
		  <tr><td width="15%" align="center" bgcolor="#EFFBFE">备注</td>
		  		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="remark" /></td>
		   </tr>
		<tr>  <td width="15%" align="center" bgcolor="#EFFBFE">类别ID</td>
		  		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="archiveclassid" /></td>
		   </tr>
    ...
    <tr>   
    	<td colspan="2" width="100%" align="center" bgcolor="#EFFBFE"><input type="submit" value=" 增加"></td>
