...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
 	...
 	<form action="/Hrm/ArchiveServlet?actioncode=alter" method="post">
  <table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#AEDEF4" style="border:1px solid #AEDEF4">
  
   	<%      
   	     Archive arc=(Archive)request.getAttribute("arc");%>
   	      <tr>
		  <td width="15%" height="25" align="center" bgcolor="#EFFBFE">档案ID</td>
		  		  <td width="15%" height="25" align="center" bgcolor="#FFFFFF"><input type="text" name="arcid" value="<%=arc.getArcId()%>" /></td>
		  </tr>
           <tr>   <td width="10%" align="center" bgcolor="#EFFBFE">人员ID</td>
              		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text"name="empid" value="<%=arc.getEmpId() %>" /></td>
            </tr>  
		<tr>  <td width="13%" align="center" bgcolor="#EFFBFE">档案编号</td>
		  		  <td width="13%" align="center" bgcolor="#FFFFFF"><input type="text"name="arcnum" value="<%=arc.getArcNum()%>" /></td>
		  </tr>
		<tr>  <td width="10%" align="center" bgcolor="#EFFBFE">名称</td>
		  		  <td width="10%" align="center" bgcolor="#FFFFFF"><input type="text" name="arcname" value="<%=arc.getArcName() %>" /></td>
		  </tr>
		 <tr> <td width="22%" align="center" bgcolor="#EFFBFE">摘要</td>
		  		  <td width="22%" align="center" bgcolor="#FFFFFF"><input type="text"name="summary" value="<%=arc.getSummary() %>" /></td>
		  </tr>
		 <tr> <td width="15%" align="center" bgcolor="#EFFBFE">备注</td>
		  		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="remark" value="<%=arc.getRemark()%>" /></td>
		  </tr>
		<tr>  <td width="15%" align="center" bgcolor="#EFFBFE">类别ID</td>
		  		  <td width="15%" align="center" bgcolor="#FFFFFF"><input type="text"name="archiveclassid" value="<%=arc.getArchiveClassId() %>" /></td>
		  
		  </tr>
		
   
    <tr>   
    	<td colspan="9" width="100%" align="center" bgcolor="#EFFBFE"><input type="submit" value=" 修改"></td>
