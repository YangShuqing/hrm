...
#xueke,#item_text2,#item_text1,#itemtypes2,#item_text3 { /**/
	...
	function change_itemtypes2(name) {
		...
		<body>
			...
			<form action="/Hrm/ContractServlet?actioncode=alter" method="post">
				<table width="99%" border="0" align="center" cellpadding="3"
					...
					<tr>
						...
						<td height="25" align="center" bgcolor="#FFFFFF">
							<input type="text" name="cosid" value="<%=contract.getCosId()%>" />
						</td>
					</tr>
					<tr>
						...
						<td align="center" bgcolor="#FFFFFF">
							<input type="text" name="empid" value="<%=contract.getEmpId()%>" />
						</td>
					</tr>
					<tr>
						<td align="center" bgcolor="#EFFBFE">
						...
						<td align="center" bgcolor="#FFFFFF">
							<input type="text" name="cosnum"
								value="<%=contract.getCosNum()%>" />
						</td>
					</tr>
					<tr>
						<td align="center" bgcolor="#EFFBFE">
					...
					<tr>
						...
						<td align="center" bgcolor="#FFFFFF">
							<input type="text" name="emddate"
								value="<%=contract.getEndDate()%>" />
						</td>
					</tr>
					<tr>
						<td align="center" bgcolor="#EFFBFE">
						...
						<td align="center" bgcolor="#FFFFFF">
							<input type="text" name="job" value="<%=contract.getJob()%>" />
						</td>
					</tr>
					<tr>
						<td align="center" bgcolor="#EFFBFE">
